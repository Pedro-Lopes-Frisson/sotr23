 ...
 * pdfl@ua.pt
 * 
 * Responsible for all the image analysis tasks such as obstacles detection, object detection, etc.
 */
...
void detect_obstacles_spiral() {
    /* Let's consider that the ground is white and the obstacles are of a different color */


    // Now, let's analyze the image
    #define MAGNITUDE 		1.5 		// minimum ratio between ground and other colors to be considered different
    ...
    int pixCountX[width], pixCountY[height]; /* Number of pixels of a different color in each column and row */
    ...
    while (1)
    {
        ...
        /* starting from the center of the image and analyzing the pixels in a spiral way */
        ...
        int spirals = calculateSpirals(PERCENTAGE * (width * height)); /* Number of spirals to be done */
        ...
        int16_t *cm_x = NULL; 	// By default not found
        int16_t *cm_y = NULL;	
